...
Original file is located at
    https://colab.research.google.com/drive/1WRg_GM90xhjWZdUNWxA3ZqoiXc_6hGFa
"""
...
scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.3, patience=6,threshold_mode='abs',min_lr=1e-8, verbose=True)
